...
def init_database():
    ...
    courses = [
        ...
        ('Πρακτική I', 'ΠΡ1', 8, 7, 'Not Taken', 'ΠΡ', 'COM', None, None, None, None, None, None, None),
        ...
        ('Πτυχιακή I', 'ΠΤ1', 8, 7, 'Not Taken', 'ΠΤ', 'COM', None, None, None, None, None, None, None),
        ...
        ('Πρακτική II', 'ΠΡ2', 8, 8, 'Not Taken', 'ΠΡ', 'COM', None, None, None, None, None, None, None),
        ('Προστασία και Ασφάλεια Υπολογιστικών Συστημάτων', 'ΥΣ13', 6, 8, 'Not Taken', 'ΠΜ', 'CS', None, None, 'B', None, None, None, None),
        ('Πτυχιακή IΙ', 'ΠΤ2', 8, 8, 'Not Taken', 'ΠΤ', 'COM', None, None, None, None, None, None, None),
